...
export function ThemeToggle() {
  ...
  return (
    <motion.div
      className=" flex items-center justify-between p-1 rounded-full bg-neutral-100 dark:bg-neutral-800 w-fit"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
...
function ThemeButton({ active, onClick, icon }: ThemeButtonProps) {
  return (
    <motion.button
      className={`cursor-pointer relative flex items-center justify-center w-8 h-8 rounded-full ${
